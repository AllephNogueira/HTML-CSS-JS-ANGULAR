...
console.log(seis)
// So que isso é muito confuso, então vamos fazer de outra maneira

const [primeiraLista, segundaLista, terceiraLista] = numeros
console.log(segundaLista); // [4, 5, 6]

const novaLista = segundaLista
console.log(novaLista); // [4, 5, 6]

const [quatro, cinco, ] = novaLista
